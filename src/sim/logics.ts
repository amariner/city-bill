...
export const LOGICS: LogicEntry[] = [
  ...
  { id: 'grief', name: 'duelo (pérdida de pareja o amigo cercano)', level: 3, files: ['sim/simulation.ts', 'citizens/citizen.ts', 'citizens/activities.ts'], couples: ['life', 'social', 'needs'] },
];
